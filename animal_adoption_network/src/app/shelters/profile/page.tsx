      ...
      <DashboardLayout>
        <div className="p-6 text-gray-800">
          ...
          <form onSubmit={handleUpdateProfile} className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700">
                Legal Document File Type (Optional)
              </label>
              <input
                type="text"
                value={legalDocumentFileType}
                onChange={(e) => setLegalDocumentFileType(e.target.value)}
                className="mt-1 border border-gray-300 rounded-md p-2"
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700">
                Legal Document File Size (Optional)
              </label>
              <input
                type="number"
                value={legalDocumentFileSize}
                onChange={(e) =>
                  setLegalDocumentFileSize(Number(e.target.value))
                }
                className="mt-1 border border-gray-300 rounded-md p-2"
              />
            </div>
